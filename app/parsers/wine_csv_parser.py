...
# def parse_wine_production_data(csv_file: str, starting_year: int, ending_year: int) -> List[WineGrape]:
#     wine_items = []
#
...
#
#             wine_item = WineGrape(code=control, name=product, category=category)
#
