...
def get_wine_grapes_production(floor_year=FLOOR_YEAR, ceiling_year=CEILING_YEAR - 1, category=None):
...
def get_wine_grapes_production_sum(floor_year=FLOOR_YEAR, ceiling_year=CEILING_YEAR - 1, category=None):
...
def get_american_hybrid_grapes_production(floor_year=FLOOR_YEAR, ceiling_year=CEILING_YEAR - 1, category=None):
...
def get_american_hybrid_grapes_production_sum(floor_year=FLOOR_YEAR, ceiling_year=CEILING_YEAR - 1, category=None):
    return get_filtered_sum(int(floor_year), (int(ceiling_year) + 1), category, AMER_GRAPE_PRO_FILE_CONFIG)


@router.get("/table_grapes")
def get_table_grapes_production(floor_year=FLOOR_YEAR, ceiling_year=CEILING_YEAR - 1, category=None):
    wine_data = get_filtered(int(floor_year), (int(ceiling_year) + 1), category, TABLE_GRAPE_PRO_FILE_CONFIG)
    return [wine.to_dict() for wine in wine_data]


@router.get("/table_grapes/sum")
def get_table_grapes_production_sum(floor_year=FLOOR_YEAR, ceiling_year=CEILING_YEAR - 1, category=None):
...
def get_declassified_grapes_production(floor_year=FLOOR_YEAR, ceiling_year=CEILING_YEAR - 1, category=None):
...
def get_declassified_grapes_production_sum(floor_year=FLOOR_YEAR, ceiling_year=CEILING_YEAR - 1, category=None):
